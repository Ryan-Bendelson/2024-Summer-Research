...
def partialTrace(kron, qubit):
    ...
    subdivisions = 4 ** (math.log2(numRows) - qubit) #Store how many subdivisions will be taken from the original density matrix
    print("\nThere will be ", subdivisions, " subdivisions for this partial trace.\n")
